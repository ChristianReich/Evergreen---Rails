...
class PrayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prayer" do
    assert_difference('Prayer.count') do
      post prayers_url, params: { prayer: { date: @prayer.date, notes: @prayer.notes, prayer_request: @prayer.prayer_request } }
    end
  ...
  test "should update prayer" do
    patch prayer_url(@prayer), params: { prayer: { date: @prayer.date, notes: @prayer.notes, prayer_request: @prayer.prayer_request } }
